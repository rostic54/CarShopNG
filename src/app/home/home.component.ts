...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const slideItems = [
      ...
      {src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfzJ4lACX-oQXtODcQid3y3KXEIyhw5hmPlbwFLeJkc9-zu8j5', title: 'Mercedes'},
      {src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS89GjSRMLPZCcDNUdD7DvZ5cxXfQ27Rhr0DJ_EKY98r_NORSgn', title: 'Buggati'},
      {src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwnU8t3wMLel2st50_R3VDUtcQC-f9K4UeWg8Vw_g16CLEYQtE', title: 'Moskalik'},
